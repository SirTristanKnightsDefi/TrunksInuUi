...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Trunks Inu home page" },
            React__default['default'].createElement("img", { src: "https://gateway.pinata.cloud/ipfs/QmQ75ECzyrvTZtv12LuhEyqqCRCrhBQPMUbzwRFS3L4vtF", alt: "Trunks Inu Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: banner, alt: "Trunks Inu Logo", className: "desktop-icon" }))) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Knights DeFi home page" },
            React__default['default'].createElement("img", { src: "https://gateway.pinata.cloud/ipfs/QmQ75ECzyrvTZtv12LuhEyqqCRCrhBQPMUbzwRFS3L4vtF", alt: "FesBNB Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: banner, alt: "Trunks Inu Logo", className: "desktop-icon" })))));
};
var templateObject_1$c;
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/TrunksInuOfficial",
            },
        ],
    },
    {
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        React__default['default'].createElement(SocialEntry, null, cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://pancakeswap.info/token/0x1050Df20e75dc87A09993596E25d7c5d9890CdeB", target: "_blank" },
            React__default['default'].createElement("img", { src: "https://gateway.pinata.cloud/ipfs/QmQ75ECzyrvTZtv12LuhEyqqCRCrhBQPMUbzwRFS3L4vtF", alt: "Trunks Inu Logo", style: {
                    width: "24px",
                    marginRight: "8px",
                } }),
